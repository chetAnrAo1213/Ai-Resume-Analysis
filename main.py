...
# Configuration for temporary file uploads (Vercel-friendly)
UPLOAD_FOLDER = '/tmp/'  # Use the temporary directory for uploads
app.config['UPLOAD_FOLDER'] = UPLOAD_FOLDER

# Ensure the upload folder exists (not strictly necessary for /tmp/)
if not os.path.exists(UPLOAD_FOLDER):
    os.makedirs(UPLOAD_FOLDER)

# Configure the Google Gemini API
genai.configure(api_key="AIzaSyAfyqOfkVsNBSCmUruRGAJeAv5eJJSS9BU")
